...
<body class="sticky-header" data-formid="<%=request.getParameter("form_id")%>">
<section>
...
<%--user js--%>
<script type="application/javascript" src="../js/user/show_result.js"></script>
