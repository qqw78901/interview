...
import com.jeff.mybatis.autobuild.NameConverter;
...
public class PageInterceptor implements Interceptor {
	...
	private void setPageParameter(String sql, Connection connection, MappedStatement mappedStatement,
		...
		try {
			...
			long totalPage = totalCount / PageContext.getPageLimit()
					+ ((totalCount % PageContext.getPageLimit() == 0) ? 0 : 1);
	...
	private String buildPageSql(String sql) {
		if (PageContext.getPageOffset() != null && PageContext.getPageLimit() != null) {
	...
	public StringBuilder buildPageSqlForMysql(String sql) {
		...
		pageSql.append(sql);
		pageSql.append(" limit " + beginrow + "," + PageContext.getPageLimit());
		return pageSql;
	}
	...
	public StringBuilder buildPageSqlForOracle(String sql) {
		StringBuilder pageSql = new StringBuilder(100);
		String beginrow = String.valueOf((PageContext.getPageOffset() - 1) * PageContext.getPageLimit());
		String endrow = String.valueOf(PageContext.getPageOffset() * PageContext.getPageLimit());
