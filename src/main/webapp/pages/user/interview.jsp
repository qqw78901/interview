                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">增加面试</h4>
                                </div>
                                <div class="modal-body">

                                    <form class="form-horizontal cmxform" role="form" id="add_form">
                                        <div class="form-group">
                                            <label class="col-lg-2 col-sm-2 control-label">面试名称</label>
                                            <div class="col-lg-10">
                                                <input type="text" class="form-control" id="title" name="title" placeholder="面试名称" required="required">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-lg-offset-2 col-lg-10">
                                                <button type="button" class="btn btn-primary form_add_btn" id="add_btn"><i class="fa fa-plus-circle"></i>&nbsp;增加</button>
                                            </div>
                                        </div>
                                    </form>
                    ...
                    <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal-2" class="modal fade">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
                                    <h4 class="modal-title">增加《<span id="add_next_header"></span>》下级面试</h4>
                                </div>
                                <div class="modal-body">

                                    <form class="form-horizontal cmxform" role="form" id="add_next_form">
                                        <div class="form-group">
                                            <label class="col-lg-2 col-sm-2 control-label">面试名称</label>
                                            <div class="col-lg-10">
                                                <input type="text" class="form-control" id="next_title" name="title" placeholder="面试名称" required="required">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-lg-offset-2 col-lg-10">
                                                <button type="button" class="btn btn-primary form_add_btn" id="add_next_btn"><i class="fa fa-plus-circle"></i>&nbsp;增加</button>
                                            </div>
                                        </div>
                                    </form>
...
<%--user js--%>
<script type="application/javascript" src="../js/user/interview.js"></script>
</body>
</html>
